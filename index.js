...
const myVehicle =new Vehicle ('1','2','3','4',);
...
// Створення нового екземпляру об'єкта Car
...
console.log(myCar.toString()); // Рядок, представляючий об'єкт
console.log(myCar.valueOf());  // Швидкість автомобіля (у даному випадку)
...
// Перевизначаємо toString для прототипу ElectricCar він має повертати <brand> <model> <year> - Батарея: <batteryCapacity> kWh
 ElectricCar.prototype.toString = function(){
  const ElectricCarString = Object.prototype.toString.call(this);
  return `${this.brand} ${this.model} ${this.year} - Батарея: ${this.batteryCapacity} kWh`;
 }
// Створюємо новий екземпляр ElectricCar
const myElectricCar = new ElectricCar('Tesla', 'Model S', 2022, 0, 100);
